...
class WebARApp {
    ...
    loadModel() {
        ...
        this.model.setAttribute('gltf-model', '#astronaut-model');
        ...
        asset.setAttribute('id', 'astronaut-model');
        asset.setAttribute('src', 'assets/models/astronaut.glb');
        
        // Добавляем ассет в сцену
        const assets = this.scene.querySelector('a-assets') || (() => {
            const assetsEl = document.createElement('a-assets');
            this.scene.appendChild(assetsEl);
            return assetsEl;
        })();
